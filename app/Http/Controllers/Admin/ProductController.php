...
class ProductController extends Controller
{
  ...
  public function form(Request $request){
    ...
    $categoryItems = $category->listItems(null, ['task' => 'admin-list-items-in-selectbox']);
    $producerItems = $producer->listItems(null, ['task' => 'admin-list-items-in-selectbox']);
    if($request->id !== null){
  ...
  public function import(Request $request) {
    ...
    $category = new CategoryModel();
    $categoryItems = $category->listItems(null, ['task' => 'admin-list-items-in-selectbox']);
    return view($this->pathViewController. 'import', [
      'params' => $this->params,
      'item' => $item,
      'categoryItems' => $categoryItems,
    ]);
  ...
  public function store(Request $request): RedirectResponse{
    if($request->method() == 'POST'){
      ...
      $this->model->saveItem($params, ['task' => 'import-item']);
      return redirect()->route($this->controllerName)->with('vn_notify', 'Đã nhập hàng thành công!');
    }
  }
